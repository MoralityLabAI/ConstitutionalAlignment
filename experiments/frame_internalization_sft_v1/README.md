...
- [`prompt_sft_contrast_v1.json`](prompt_sft_contrast_v1.json) and [`PROTOCOL_AMENDMENT_DIRECT_PROMPT_SFT_V1.md`](PROTOCOL_AMENDMENT_DIRECT_PROMPT_SFT_V1.md): prospective matched direct prompt-versus-SFT estimands, joins, sampling, decoding, and simultaneous-interval contract.
...
- [`readiness/pre_spend_readiness_20260719_v2.json`](readiness/pre_spend_readiness_20260719_v2.json): current audit receipt; the direct prompt-versus-SFT contract passes, leaving the same six compute blockers and `pilot_ready: false`.
...
- [`LICENSE_RESOLUTION_HANDOFF.md`](LICENSE_RESOLUTION_HANDOFF.md): fail-closed evidence and resolution paths for the undeclared harmful-source license; no license approval is implied.
...
- [`rerun_freeze/nonleakage_source_prompts_v1.json`](rerun_freeze/nonleakage_source_prompts_v1.json): passed source-prompt precursor audit; generated text remains to be audited.
- [`rerun_freeze/predecessor_reanchor_progress_v1.json`](rerun_freeze/predecessor_reanchor_progress_v1.json): bound predecessor inputs, passed subgates, and outstanding inference, license, human-label, probe, and row-join evidence.

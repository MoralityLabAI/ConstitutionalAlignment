#!/usr/bin/env python3
"""Helpers for model-family detection, optional runtime patching, and neutral path defaults."""
...
def default_runs_root() -> Path:
    return default_pipeline_root() / "runs"
...
def inspect_model_family(model_id: str | None = None, revision: str = "main", cache_dir: str | None = None) -> dict:
    ...
    try:
        ...
        lower_architectures = [arch.lower() for arch in architectures]
        afmoe_required = model_type.lower() == "afmoe" or any("afmoe" in arch for arch in lower_architectures)
